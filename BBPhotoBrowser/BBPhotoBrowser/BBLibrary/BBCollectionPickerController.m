        ...
        if ([collection isKindOfClass:[PHAssetCollection class]]) {
            ...
            if (assetCollection.assetCollectionSubtype != PHAssetCollectionSubtypeSmartAlbumUserLibrary) {
                if (assetCollection.estimatedAssetCount == NSNotFound) {
                    PHFetchResult *result = [PHAsset fetchAssetsInAssetCollection:assetCollection options:self.asseBBetchOptions];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    if (indexPath.section < [self _momentsSections]) {
        ...
        [PHCollection bb_requestThumbnailForMomentsWithAssetsFetchOptions:self.asseBBetchOptions
        ...
        if ([collection isKindOfClass:[PHAssetCollection class]]) {
            ...
            cell.thumbnailView.image = BBPhotoBrowserImageNamed(@"BBLibraryCollectionIcon");
            [collection bb_requestThumbnailWithAssetsFetchOptions:self.asseBBetchOptions completion:^(UIImage *result) {
                if (result != nil) {
                    cell.thumbnailView.image = result;
                }
            }];
            ...
            [collection bb_requestThumbnailWithAssetsFetchOptions:self.asseBBetchOptions
                                                       completion:^(UIImage *result)
             {
                 if (result != nil) {
                     cell.thumbnailView.image = result;
...
- (CGFloat)tableView:(UITableView *)tableView heighBBorRowAtIndexPath:(NSIndexPath *)indexPath {
    BOOL hidden = NO;
