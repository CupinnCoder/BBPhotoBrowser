...
@interface BBMomentHeaderView () {
    UIVisualEffectView *_backgroundView;
    UIView *_centeringView;
}
@end

@implementation BBMomentHeaderView
...
//    _centeringView.layer.borderWidth = 1;
    ...
    [_selectedButton setImage:[UIImage imageNamed:@"BBLibraryResource.bundle/images/BBLibraryCollectionUnSelected.png"] forState:UIControlStateNormal];
    [_selectedButton setImage:[UIImage imageNamed:@"BBLibraryResource.bundle/images/BBLibraryCollectionSelected.png"] forState:UIControlStateSelected];
