...
#ifndef BBPhotoBrowserLocalizedStrings
#define BBPhotoBrowserLocalizedStrings(key) \
NSLocalizedStringFromTableInBundle((key), nil, [NSBundle bundleWithPath:[[NSBundle bundleForClass: self.class] pathForResource:@"BBPhotoBrowserLocalizations" ofType:@"bundle"]], nil)
#endif
